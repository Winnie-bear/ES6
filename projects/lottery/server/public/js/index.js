...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(329)(module)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"babel-ployfill\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var _calculate = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./lottery/calculate\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  _createClass(Base, [{
	    ...
	    */
	    ...
	    value: function getCount() {
	      ...
	      var count = self.computeCount(active, self.cur_play);
	      var range = self.computeBonus(active, self.cur_play); //返回值是一个数组
	      //价格(本金),一注2元
	      var money = count * 2;
	      //盈利或亏损
	    ...
	    */
	    ...
	    key: 'getRandom',
	    value: function getRandom(playNum) {
	      var arr = [],
	          index = void 0; //存放指定个数的随机数
	    ...
	    */
	    ...
	    value: function getRandomCode(e) {
	      ...
	      //玩法个数
	      var play = self.cur_play.match(/\d+/g)[0];
	      if (num === '0') {
	...
	var Timer = function () {
	  ...
	  _createClass(Timer, [{
	    ...
	    value: function (_countdown) {
	      ...
	      var now = new date().getTime(); //返回的是毫秒数
	      var self = this;
	      if (now - end > 0) {
	        //倒计时结束
	        handle.call(self);
